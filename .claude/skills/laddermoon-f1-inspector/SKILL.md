...
2. **Check against organization principles**
   ...
   **Principle 1-4: Intuitive → Macro → Micro structure**
   ...
   | Macro | Is the architecture described? | "What is the high-level structure?" |
   | Macro | Are main components listed? | "What are the key components?" |
...
3. **Evaluate from project manager perspective**

   A project manager wanting to understand the project would ask:
   - What is this project? (purpose, scope)
